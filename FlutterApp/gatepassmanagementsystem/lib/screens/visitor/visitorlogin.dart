...
import 'package:gatepassmanagementsystem/screens/visitor/visitorregister.dart';
...
class _VisitorLoginState extends State<VisitorLoginPage>{
  bool loading = false;
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text("Visitor Login",style: TextStyle(color: Colors.red[900],
                fontSize: 30,
            ...
            Row(
              ...
              children: [
                Text("Register as new Visitor.", style: TextStyle(color: Colors.grey),),
                Container(
                  height: 25,
                  width : 120,
                  child :FlatButton(
